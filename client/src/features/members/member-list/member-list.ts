...
export class MemberList implements OnInit{
  ...
  get displayMessage(): string{
    const defaultParamas = new MemberParams();
    ...
    if(this.updatedParams.minAge !== defaultParamas.minAge
      || this.updatedParams.maxAge !== defaultParamas.maxAge){
        filters.push(` ages ${this.updatedParams.minAge}-${this.updatedParams.maxAge}`)

      }

      filters.push(this.memberParams.orderBy === 'lastActive'
